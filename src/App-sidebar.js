              ...
              <div className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style={{width: '280px'}}>
                ...
                <div className="dropdown">
                  <ul className="dropdown-menu dropdown-menu-dark text-small shadow">
                    ...
                    <DropdownButton id="dropdown-basic-button" title="Ollama" style={{marginLeft: '60px'}}>
                      {renderModels(ollamaModels, setSelectedModel, setSelectedPrompt)}
                    </DropdownButton>
                    <DropdownButton id="dropdown-basic-button" title="OpenAI" style={{marginLeft: '10px'}}>
                      {renderModels(openaimodels, setSelectedModel, setSelectedPrompt)}
                    </DropdownButton>

                    <DropdownButton id="dropdown-basic-button" title="Prompt" style={{marginLeft: '10px'}}>
                      {renderPrompts()}
                    </DropdownButton>
                  </ul>
                </div>
            ...
            {loading ? (
              ...
              <div id="chat-box">
                {chatHistory.map((message, index) => (
                  <div id="message.request" key={index} className="alert alert-secondary" role="alert">
